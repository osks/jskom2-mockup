...
<div
	...
	style="mask-image: linear-gradient(to bottom, transparent 0%, transparent 0.5rem, rgba(0,0,0,0.03) 30%, rgba(0,0,0,0.1) 50%, rgba(0,0,0,0.4) 75%, black calc(env(safe-area-inset-top, 0px) + 4.125rem)); -webkit-mask-image: linear-gradient(to bottom, transparent 0%, transparent 0.5rem, rgba(0,0,0,0.03) 30%, rgba(0,0,0,0.1) 50%, rgba(0,0,0,0.4) 75%, black calc(env(safe-area-inset-top, 0px) + 4.125rem));"
>
