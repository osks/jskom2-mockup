...
<div
	...
	style="mask-image: linear-gradient(to bottom, rgba(0,0,0,0.05), rgba(0,0,0,0.3) calc(env(safe-area-inset-top, 0px) + 3.5rem), black calc(env(safe-area-inset-top, 0px) + 4.125rem)); -webkit-mask-image: linear-gradient(to bottom, rgba(0,0,0,0.05), rgba(0,0,0,0.3) calc(env(safe-area-inset-top, 0px) + 3.5rem), black calc(env(safe-area-inset-top, 0px) + 4.125rem));"
>
