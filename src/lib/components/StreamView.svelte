...
<div
	...
	style="mask-image: linear-gradient(to bottom, transparent, black calc(env(safe-area-inset-top, 0px) + 4rem)); -webkit-mask-image: linear-gradient(to bottom, transparent, black calc(env(safe-area-inset-top, 0px) + 4rem));"
>
