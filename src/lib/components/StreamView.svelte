...
<div
	...
	style="mask-image: linear-gradient(to bottom, transparent, black calc(env(safe-area-inset-top, 0px) + 3.75rem)); -webkit-mask-image: linear-gradient(to bottom, transparent, black calc(env(safe-area-inset-top, 0px) + 3.75rem));"
>
