...
{#if hasTexts || nextAction.type !== 'all-done'}
	...
	<div class="safe-bottom pointer-events-none fixed inset-x-0 bottom-0 z-20 flex items-end justify-center px-6 pb-5 md:pb-8 md:left-72 transition-opacity duration-200"
