...
<div
	...
	style="mask-image: linear-gradient(to bottom, transparent, black calc(env(safe-area-inset-top, 0px) + 2rem)); -webkit-mask-image: linear-gradient(to bottom, transparent, black calc(env(safe-area-inset-top, 0px) + 2rem));"
>
