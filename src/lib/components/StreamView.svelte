...
<div
	...
	style="mask-image: linear-gradient(to bottom, transparent 5px, rgba(0,0,0,0.15) calc(env(safe-area-inset-top, 0px) + 2rem), rgba(0,0,0,0.25) calc(env(safe-area-inset-top, 0px) + 3rem), rgba(0,0,0,0.5) calc(env(safe-area-inset-top, 0px) + 3.5rem), black calc(env(safe-area-inset-top, 0px) + 4.125rem)); -webkit-mask-image: linear-gradient(to bottom, transparent 5px, rgba(0,0,0,0.15) calc(env(safe-area-inset-top, 0px) + 2rem), rgba(0,0,0,0.25) calc(env(safe-area-inset-top, 0px) + 3rem), rgba(0,0,0,0.5) calc(env(safe-area-inset-top, 0px) + 3.5rem), black calc(env(safe-area-inset-top, 0px) + 4.125rem));"
>
