		...
		<div class="pointer-events-auto flex w-full max-w-md items-center gap-2.5">
			...
			{#if activeText}
				<div class="relative">
					<button
						...
						class="flex h-11 w-11 items-center justify-center rounded-full bg-white/90 backdrop-blur-sm ring-1 ring-gray-200 active:bg-gray-100"
			...
			{#if activeText}
				<button
					...
					class="flex h-11 min-w-0 flex-1 items-center rounded-full bg-white/90 backdrop-blur-sm px-4 ring-1 ring-gray-200 active:bg-gray-50"
				>
			...
			{#if nextAction.type !== 'all-done'}
				<button
					...
					class="flex h-12 w-12 items-center justify-center rounded-full bg-gray-900/90 backdrop-blur-sm active:bg-gray-700"
