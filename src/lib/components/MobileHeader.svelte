...
<div class="fixed top-0 left-0 right-0 z-20 bg-gray-50/95 backdrop-blur-sm md:hidden">
	<div class="safe-top"></div>
	<div class="flex h-14 items-center gap-3 border-b border-gray-200 px-4">
		<button
