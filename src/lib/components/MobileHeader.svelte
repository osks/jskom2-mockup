...
<div
	...
	style="backdrop-filter: blur(2px); -webkit-backdrop-filter: blur(2px); mask-image: linear-gradient(to bottom, black, black 50%, transparent); -webkit-mask-image: linear-gradient(to bottom, black, black 50%, transparent);"
></div>
