...
<div class="safe-top fixed top-0 left-0 right-0 z-20 flex min-h-14 items-center gap-3 bg-white/95 backdrop-blur-sm border-b border-gray-100 px-4 pb-2 md:hidden">
	<button
