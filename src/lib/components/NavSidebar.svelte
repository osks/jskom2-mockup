	...
	{#if $activeConnection}
		<div class="relative">
			...
			{#if menuOpen}
				...
				<div class="absolute bottom-full left-0 right-0 z-40 mb-2 rounded-2xl bg-surface-1 py-1.5 shadow-[0_2px_8px_rgba(0,0,0,0.08)] border-[0.5px] border-surface-4/30">
						<!-- Other connections -->
