...
{#if visible}
	<div class="pointer-events-none fixed left-0 right-0 bottom-0 z-20 flex items-end justify-center px-7 md:px-4 md:left-80" style="padding-bottom: max(calc(env(safe-area-inset-bottom, 0px) - 4px), 1.25rem);"
